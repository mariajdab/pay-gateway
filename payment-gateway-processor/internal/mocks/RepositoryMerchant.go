...
// MerchantAccountByCode provides a mock function with given fields: code
func (_m *RepositoryMerchant) MerchantAccountByCode(code string) (string, error) {
	ret := _m.Called(code)

	if len(ret) == 0 {
		panic("no return value specified for MerchantAccountByCode")
	}
